    ...
    return (
        <TouchableOpacity onPress={props.toNavigateBookHandler}>
            ...
            <View style={{ flex: 0.5, flexDirection: 'row', height: '70%', width: '95%', padding: 10, justifyContent: 'flex-start', marginLeft: 10, marginTop: 10 }}>
                ...
                <View style={{ justifyContent: 'flex-end', backgroundColor: 'white', flex: 1.4, padding: 10, borderTopRightRadius: 10, borderBottomRightRadius: 10 }}>
                    ...
                    <Rating
                        ...
                        direction="row"
                    />
                    <Text style={{ marginBottom: 5, marginTop: 10, fontSize: 10 }}>{bookController.checkDescription(props.item)}</Text>
                    {props.from === "library" &&
                        <View
                            style={{
                                flexDirection: 'row',
                                alignContent: 'space-around', justifyContent: 'flex-end',
                            }}>

                            <TouchableOpacity
                                style={{
                                    flex: 1,
                                    backgroundColor: '#FF6EA1', elevation: 20, marginTop: 20,
                                    shadowColor: '#52006A', height: 35, borderRadius: 5, shadowColor: 'black', justifyContent: 'center', marginRight: 10
                                }}
                            ...
                            <TouchableOpacity
                                style={{
                                    ...
                                    marginTop: 20,
                                    elevation: 20,
                                    shadowColor: '#52006A', backgroundColor: 'white', flex: 1, height: 35, justifyContent: 'center', borderRadius: 5
                                }}
                    ...
                    {props.from === "favorites" && <View style={{
                        flexDirection: 'row',
                        alignContent: 'space-around', justifyContent: 'flex-end',
                    }}>
                        <TouchableOpacity
                            ...
                            <View>
                                <Text style={{ color: 'white', fontSize: 12, textAlign: 'center', fontWeight: 'bold' }}>Details</Text>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity
                            style={{
                                marginTop: 17, backgroundColor: 'white', elevation: 20,
                                shadowColor: '#52006A', flex: 1, height: 35, borderRadius: 5, shadowColor: 'black', justifyContent: 'center', marginRight: 10
                            }}
                        ...
                        >
                            ...
                            <View>
                                <Text style={{ color: 'black', fontSize: 12, textAlign: 'center', fontWeight: 'bold' }}>Remove</Text>
                            </View>
                        </TouchableOpacity>

                    </View>}
                    {props.from === "store" && <View style={{
                        flexDirection: 'row',
                        alignContent: 'space-around', justifyContent: 'flex-end',
                    }}>
                        <TouchableOpacity
