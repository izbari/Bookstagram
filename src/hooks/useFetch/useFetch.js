...
function getTopics(check) {
  ...
  if (check) {
    i = 1;
    categories.unshift("")
    images.push({ id: -1, url: "https://firebasestorage.googleapis.com/v0/b/bookstagram-325020.appspot.com/o/plus-svgrepo-com.svg?alt=media&token=104c07dd-ef75-4900-add0-b7b1ffd47790" })
  }
